...
{
    protected $fillable = ['question','answer','sorting'];

    protected const CACHE_NAME    = '_faqs';
    ...
    **************************************/
    ...
    public static function allFaqs(){
        return Cache::rememberForever(self::CACHE_NAME, function () {
            return self::toBase()->select('id','question','answer','sorting')->orderBy('sorting','asc')->get();
        });
    }
