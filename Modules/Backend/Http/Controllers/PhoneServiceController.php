...
class PhoneServiceController extends BaseController
{
    ...
    {
        if (permission('phone-service-access')) {
    ...
    {
        if($request->ajax()){
            if (permission('phone-service-add') || permission('phone-service-edit')) {
