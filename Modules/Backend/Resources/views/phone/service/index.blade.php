...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <!--Begin:: Modal-->
    @include('backend::phone.service.modal')
    <!--End:: Modal-->
</div>
@endsection
...
$(document).ready(function () {
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('admin.phone.service.list')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $('#saveDataForm').on('submit', function(event){
        ...
        let url = "{{route('admin.phone.service.store')}}";
        let method;
        if(id){
            method = "update";
        }else{
    ...
    $(document).on('click','.edit_data',function () {
        ...
        $.ajax({
            url: "{{route('admin.phone.service.edit')}}",
            type: "POST",
    ...
    $(document).on('click','.delete_data',function () {
        ...
        let id  = $(this).data('id');
        let url = "{{route('admin.phone.service.delete')}}";
    ...
    $(document).on("click",'#bulk_action_delete',function() {
        ...
        if(id.length === 0) //tell us if the array is empty
        {
            ...
            let url = "{{route('admin.phone.service.bulkaction')}}";
