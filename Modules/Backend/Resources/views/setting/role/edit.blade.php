            ...
            <div class="row">
                <div class="col-xl-12">
                    <form method="post" id="saveDataForm">
                        @csrf
                        <input type="hidden" class="form-control" name="update_id" id="update_id" value="{{$role->id}}">
                        <div class="row">
                            <x-backend.form.text-box label="Role Name" col="col-md-12" name="role" value="{{$role->role}}" required="required" placeholder="Enter role name"/>
                                ...
                                <ul id="permission" class="text-left">
                                    @if (!$permissions->isEmpty())
                                        @foreach ($permissions as $menu)
                                            ...
                                            <li>
                                                <input type="checkbox" @if (collect($role_modules)->contains($menu->id)) {{'checked'}} @endif
                                                class="module" name="module[]" value="{{$menu->id}}"> {{$menu->module_name}}
                                                ...
                                                <ul>
                                                    ...
                                                    <li><input type="checkbox" @if (collect($role_methods)->contains($method->id))
                                                        {{'checked'}} @endif name="method[]" value="{{$method->id}}"> {{$permission_name}}</li>
                                                    @endforeach
                                                </ul>
                                                @endif
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <input type="checkbox"  @if (collect($role_modules)->contains($submenu->id))
                                                        {{'checked'}} @endif  class="module" name="module[]" value="{{$submenu->id}}"> {{$submenu->module_name}}
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><input type="checkbox"  @if (collect($role_methods)->contains($method->id))
                                                                {{'checked'}}
                                                            @endif name="method[]" value="{{$method->id}}"> {{$permission_name}}</li>
                                                            @endforeach
                                                        </ul>
                                                        @endif
                                                    </li>
